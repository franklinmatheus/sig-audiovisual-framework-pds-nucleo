 ...
 * @author franklin
 */
public abstract class SelectAudiovisual extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Audiovisual Audiovisual = (Audiovisual) services.getAudiovisualDAO().select(id);

            ArrayList<Rating> ratings = services.getRatings(id);
